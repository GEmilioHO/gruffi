...
**This forked version allows to identify stressed cells in mouse datasets too.**
...
# or "ensembl <- biomaRt::useEnsembl('ensembl', dataset = 'mmusculus_gene_ensembl')" if working with mouse data
